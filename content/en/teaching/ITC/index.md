...
**Week 7** - Computing $\mu$-recursive functions by regular $k$-tape Turing machines. Slides: second part of TCS-8, first part of TCS-9 (second part of TCS-9 will not be covered). 
<ul style="list-style-type:disc;">
